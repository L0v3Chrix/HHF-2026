...
export const metadata = {
  title: "Scholarship Application - Step 1 | Heart Forward",
  description:
    "Share what you feel comfortable sharing. Your story belongs to you.",
};
          ...
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="glass rounded-2xl p-8">
              <form className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-[var(--hf-text-primary)] mb-2">
                    Preferred name <span className="text-[var(--hf-text-muted)]">(Optional)</span>
                  </label>
                  <input
                    type="text"
                ...
                {/* Continue Button */}
                <Link
                  href="/scholarships/apply/about-you"
                  className="block w-full px-6 py-3 rounded-full bg-[var(--hf-accent)] text-white font-medium text-center hover:bg-[var(--hf-accent-hover)] transition-colors"
                >
                  Continue
                </Link>
              </form>
